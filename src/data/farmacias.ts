...
export const farmacias: Record<FarmaciaKey, Farmacia> = {
  hunko: {
    ...
    mail:'info@farmaciahunko.com.ar',
    horarioSemana: '09:00 - 13:00 y 16:00 - 20:00 hs',
    horarioSabado: '09:00 - 13:00 hs',
    obrasSociales: ['OSDE', 'Medife', 'Swiss Medical', 'PAMI', 'Ioma', 'Luis Pasteur', 'Medicus', 'Galeno','Avalian','SanCorSalud'],
    googleMapsEmbed:
  ...
  social: {
    ...
    mail:'info@farmaciasocialhunko.com.ar',
  ...
  sudamerica: {
    ...
    mail:'info@farmaciasudamerica.com.ar',
    horarioSemana: '09:00 - 20:00 hs',
    horarioSabado: '09:00 - 13:00 hs',
    obrasSociales: ['Galeno','Swiss Medical','IOMA'],
    googleMapsEmbed:
